...
public class frame1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jbtndelete.setFont(new java.awt.Font("Trebuchet MS", 1, 20)); // NOI18N
        ...
        jPanel1.add(jbtndelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 400, 110, 30));

        jbtnupdate.setFont(new java.awt.Font("Trebuchet MS", 1, 20)); // NOI18N
        ...
        jPanel1.add(jbtnupdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 400, -1, 30));
    ...
    private void jbtndeleteActionPerformed(java.awt.event.ActionEvent evt) {                                           
        ...
        if(Validation() == 0){
            ...
            try
            {
                koneksi konek = new koneksi() {};
                Connection connect = konek.open();
                String sql = "delete Lapangan values (?,?,?,?,?)";
                PreparedStatement ps = koneksi.prepareStatement(sql);
                ps.setString(1, id);
                ps.setString(2, name);
                ps.setString(3, lenght);
                ...
                if(rows!=0)
                {
                    JOptionPane.showConfirmDialog(null, "DELETE SUCCES");
                }
                else
                {
                    JOptionPane.showConfirmDialog(null, "ERROR");
    ...
    private void jbtnupdateActionPerformed(java.awt.event.ActionEvent evt) {                                           
        ...
        if(Validation() == 0){
            ...
            try
            {
                koneksi konek = new koneksi() {};
                Connection connect = konek.open();
                String sql = "update Lapangan values (?,?,?,?,?)";
                PreparedStatement ps = koneksi.prepareStatement(sql);
                ps.setString(1, id);
                ps.setString(2, name);
                ps.setString(3, lenght);
                ...
                if(rows!=0)
                {
                    JOptionPane.showConfirmDialog(null, "UPDATE SUCCES");
                }
                else
                {
                    JOptionPane.showConfirmDialog(null, "ERROR");
